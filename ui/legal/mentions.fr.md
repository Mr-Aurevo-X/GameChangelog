Mentions légales — Game Changelog
Produit : Game Changelog (GameChangelog)
Éditeur : Mr-Aurevo-X
Copyright © 2026 Mr-Aurevo-X. Tous droits réservés.

« Game Changelog » / « GameChangelog » désigne cette application. « Mr-Aurevo-X » désigne l’éditeur.

Chaque fenêtre peut afficher : « © 2026 Mr-Aurevo-X ». Le détail (CGU, confidentialité, licences) est dans À propos.

Contact / dépôt : https://github.com/Mr-Aurevo-X/GameChangelog
